...
class Config(object):
    # Pyrogram Client
    API_ID    = int(os.environ.get("API_ID", "21209802"))  # ⚠️ Required
    API_HASH  = os.environ.get("API_HASH", "eed1c8387c6ee80009527e07d9d58cc0") # ⚠️ Required
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6737627560:AAFhAIAmk870kBurK1X0lAtObH1HgBPOCfI") # ⚠️ Required
    
    # Other Configs
    BOT_START_TIME = time.time()
    OWNER    = int(os.environ.get("OWNER", "6716174264"))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "6716174264").split()))  # ⚠️ Required
    # Web Response Config
...
☛ For e.g :- <code> @ </code> or <code> https:/t.me/SASHIKANT_XD </code>
"""
...
Tʜɪs Bᴏᴛ ɪs ғᴏʀ ᴛᴏ ʀᴇᴘᴏʀᴛ ᴄʜᴀɴɴᴇʟ ᴏʀ ɢʀᴏᴜᴘ ɪɴ ᴍᴀss ʟᴇᴠᴇʟ ᴛʜʀᴏᴜɢʜ ᴛᴇʟᴇɢʀᴀᴍ ᴀᴄᴄᴏᴜɴᴛ sᴇssɪᴏɴ sᴛʀɪɴɢ ᴡʜɪᴄʜ ʏᴏᴜ ᴄᴀɴ ɢᴇɴᴇʀᴀᴛᴇ ʙʏ @SASHIKANT_XD

Tʜɪs ʙᴏᴛ ɪs sᴏʟᴇʟʏ ᴄʀᴇᴀᴛᴇ ᴏʀ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ :- @SASHIKANT_XD
"""
